...
const OurTeam = () => {
    ...
    let teamCareer = ' mt-[30px] sm2:w-[360px] sm:w-[360px] md:w-[450px] lg:w-[450px] mx-auto sm:grid sm:grid-cols-2 md:grid md:grid-cols-2  lg:grid lg:grid-cols-2  sm:gap-x-6 sm:gap-y-4 md:gap-x-10 md:gap-y-7 lg:gap-x-12 lg:gap-y-7   text-center text-green-800'
