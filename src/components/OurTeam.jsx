...
const OurTeam = () => {
    ...
    let ballMan = '  w-[400px]'
    let ball = 'sm2:mx-auto sm:mx-auto lg:absolute md:absolute sm:absolute z-10 lg:left-[-100px]  md:left-[-50px]   sm:left-[10px]   sm:w-[150px] sm2:w-[120px] md:w-[200px] lg:w-[300px]'
