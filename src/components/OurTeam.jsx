...
const OurTeam = () => {
    ...
    let ourTTTeam = "relative border-b-4 border-green-500 z-100 relative  bg-[url('./img/crfield.jpg')] lg:bg-cover md:bg-contain sm:bg-contain  bg-no-repeat bg-bottom "
   
    let ourTeam = " mx-auto "
    let counterAnimation = ' w-[80%] pt-[20px] mx-auto flex  justify-between'
    let counterBox = 'flex flex-col items-center justify-center  rounded-full border-4 border-green-500 sm:w-[160px] md:w-[200px] lg:w-[300px] sm:h-[160px] md:h-[200px] lg:h-[300px] bg-green-200 sm:text-[50px] md:text-[70px] lg:text-[100px] font-sans2'
    ...
    let ballMan = '  w-[400px]'
    let ball = 'lg:absolute md:absolute sm:absolute z-10 lg:left-[-100px]  md:left-[-50px]   sm:left-[10px]  sm:w-[150px] md:w-[200px] lg:w-[300px]'
    let man = 'box-border  sm:mx-auto sm:w-[150px] md:w-[200px] lg:w-[500px]'
    ...
    let teamTitle = 'font-sans2 sm:text-[35px] md:text-[40px] lg:text-[50px] '
    let teamTalk = 'lg:w-[400px] mx-auto font-bold'
    let teamCareer = 'mt-[30px] sm:w-[360px] md:w-[450px] lg:w-[450px] mx-auto sm:grid sm:grid-cols-2 md:grid md:grid-cols-2  lg:grid lg:grid-cols-2  sm:gap-x-6 sm:gap-y-4 md:gap-x-10 md:gap-y-7 lg:gap-x-12 lg:gap-y-7   text-center text-green-800'
    let careerBox = ' p-[10px] rounded-md sm:w-[150px] md:w-[200px] lg:w-[200px] flex flex-col items-center text-center '
    let careerTitle = 'pb-[5px] sm:font-semibold sm:text-[15px] pt-[15px] md:font-bold md:text-[20px] pt-[20px] lg:font-bold lg:text-[20px] lg:pt-[20px]'
        ...
        <div className={teamBBox}>
         <div className={teamBox}>
             ...
             <div className={ballMan}>
                  <div data-aos='zoom-in-left' className={ball}><img src={imgBall} alt='ball' /></div>
                  <div data-aos='fade-right' className={man}><img src={imgMan} alt='man'/></div>
             </div>
             ...
             <div className={oneTeam}>
                   ...
                   <div className={teamCareer}>
                        <div data-aos='fade-right' className={careerBox}>
                        ...
                        <div data-aos='fade-left' className={careerBox}>
                            <FaCheckCircle className={careerCircle} size='80px'/>
                            <h1 className={careerTitle}>Career-Oriented</h1>
                            <h4 className={careerTalk}>Become a professional baseball player by 
                             becoming our team member.</h4>
